...
namespace RoomTileSystem.Core
{
    ...
    {
        private const string LocalVersionPath = @"C:\ProgramData\RoomTileSystem\App\version.json";
        private const string StagingDir = @"C:\ProgramData\RoomTileSystem\Update\Staging";
        private const string BackupDir = @"C:\ProgramData\RoomTileSystem\Update\Backup";
        private const string PendingUpdatePath = @"C:\ProgramData\RoomTileSystem\Update\pending_update.json";
        private const string AppSettingsPath = @"C:\ProgramData\RoomTileSystem\Config\appsettings.json";
        ...
        public static async Task<bool> StartUpdateProcessAsync(UpdateManifest manifest)
        {
            try
            {
                ...
                var pendingInfo = new PendingUpdateInfo
                {
                    ...
                    install_dir = @"C:\ProgramData\RoomTileSystem\App",
