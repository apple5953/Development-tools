...
namespace RoomTileSystem.Algorithms
{
    public static class TileDimensionDetector
    {
        ...
        /// </summary>
        public static RoomTileSystem.Core.TilePatternParams DetectPatternParams(Element elem, Document doc, double defaultW, double defaultH, double defaultJoint, double defaultThickness)
        {
            RoomTileSystem.Core.TilePatternParams parameters = new RoomTileSystem.Core.TilePatternParams
            {
                Style = RoomTileSystem.Core.TilePatternStyle.Stack,
                TileWidth = defaultW,
                TileHeight = defaultH,
            ...
            foreach (string text in sources)
            {
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.DoubleHeightStack;
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.DoubleWidthStack;
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.HexagonJoint;
                    continue;
                }
                if (text.Contains("六邊形"))
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.HexagonSeamless;
                    continue;
                }
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.FourTriangles;
                    continue;
                }
                if (text.Contains("二塊三角"))
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.TwoTriangles;
                    continue;
                }
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.Herringbone;
                    continue;
                }
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.HorizontalJoint;
                    continue;
                }
                if (text.Contains("垂直縫"))
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.VerticalJoint;
                    continue;
                }
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.RunningBond;
                ...
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.StackSplit;
                    continue;
                }
                if (text.Contains("堆疊錯位"))
                {
                    parameters.Style = RoomTileSystem.Core.TilePatternStyle.StackOffset;
                    continue;
                }
            }
