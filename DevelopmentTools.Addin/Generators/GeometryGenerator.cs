    ...
    public class GeometryGenerator
    {
        ...
        public void GetHostFinishMaterialAndThickness(Element host, ElementId targetMaterialId, out ElementId tileMatId, out double thicknessMm, double defaultMm)
        {
            ...
            if (targetMaterialId != ElementId.InvalidElementId)
            {
                ...
                if (targetMat != null && DevelopmentTools.Algorithms.TileDimensionDetector.TryParseThicknessFromNameFlexible(targetMat.Name, out double tVal))
                {
                    tFromTarget = tVal;
                }
            }
            ...
            {
                thicknessMm = DevelopmentTools.Algorithms.TileDimensionDetector.DetectThickness(host, _doc, defaultMm);
            }
